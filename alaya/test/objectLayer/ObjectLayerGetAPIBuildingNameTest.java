...
public class ObjectLayerGetAPIBuildingNameTest extends MainClassAlaya {
	...
	public void verifySuccessForGetAPIObjectLayer() throws InterruptedException, JsonMappingException, JsonProcessingException, ParseException {
		...
		ObjectLayerGetAPIPage.verifySuccessStatusforGETAPIObjectLayer(httpRequest,buildingName);	
	}
	...
	public void verifyResponseForWrongSystemLocaleObjectMethod() {
		RequestSpecification httpRequest= null;
		ObjectLayerGetAPIPage.verifyResponseForWrongSystemLocale(httpRequest,buildingName);
	}
	...
	public void verifyResponseForWrongDocumentTypeObjectMethod() {
		RequestSpecification httpRequest= null;
		ObjectLayerGetAPIPage.verifyResponseForWrongDocType(httpRequest,buildingName);
	}
	...
	public void verifyResponseForWrongDocumentObjectMethod() {
		RequestSpecification httpRequest= null;
		ObjectLayerGetAPIPage.verifyResponseForWrongDocument(httpRequest,buildingName);
	}
	...
	public void verifyResponseForDeletedDocumentObjectMethod() {
		RequestSpecification httpRequest= null;
		ObjectLayerGetAPIPage.verifyResponseForDeletedDocument(httpRequest,buildingName);
	}
	...
	public void verifyAttributesObjectMethod() {
		...
		ObjectLayerGetAPIPage.verifyAttributesForObjectLayer(httpRequest,buildingName,AttributeNamesForDocStore,AttributeNamesForES);
	}
	...
	public void verifyForbiddenRequestForInvalisSessionObjectMethod() {
		RequestSpecification httpRequest= null;
		ObjectLayerGetAPIPage.verifyWrongSessionKeyForGETAPIObjectLayer(httpRequest,buildingName);
	}
	...
	public void verifyForbiddenRequestForInvalidBearerTokenObjectMethod() {
		RequestSpecification httpRequest= null;
		ObjectLayerGetAPIPage.verifyWrongBearerTokenForGETAPIObjectLayer(httpRequest,buildingName);
	}
