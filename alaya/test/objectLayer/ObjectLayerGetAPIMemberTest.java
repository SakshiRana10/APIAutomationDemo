...
public class ObjectLayerGetAPIMemberTest extends MainClassAlaya{
	...
	public void verifySuccessForGetAPIObjectLayer() throws InterruptedException, JsonMappingException, JsonProcessingException, ParseException {
		...
		ObjectLayerGetAPIPage.verifySuccessStatusforGETAPIObjectLayer(httpRequest,member);	
	}
	...
	public void verifyResponseForWrongSystemLocaleObjectMethod() {
		RequestSpecification httpRequest= null;
		ObjectLayerGetAPIPage.verifyResponseForWrongSystemLocale(httpRequest,member);
	}
	...
	public void verifyResponseForWrongDocumentTypeObjectMethod() {
		RequestSpecification httpRequest= null;
		ObjectLayerGetAPIPage.verifyResponseForWrongDocType(httpRequest,member);
	}
	...
	public void verifyResponseForWrongDocumentObjectMethod() {
		RequestSpecification httpRequest= null;
		ObjectLayerGetAPIPage.verifyResponseForWrongDocument(httpRequest,member);
	}
	...
	public void verifyResponseForDeletedDocumentObjectMethod() {
		RequestSpecification httpRequest= null;
		ObjectLayerGetAPIPage.verifyResponseForDeletedDocument(httpRequest,member);
	}
	...
	public void verifyAttributesObjectMethod() {
		...
		ObjectLayerGetAPIPage.verifyAttributesForObjectLayer(httpRequest,member,AttributeNamesForDocStore,AttributeNamesForES);
	}
	...
	public void verifyForbiddenRequestForInvalisSessionObjectMethod() {
		RequestSpecification httpRequest= null;
		ObjectLayerGetAPIPage.verifyWrongSessionKeyForGETAPIObjectLayer(httpRequest,member);
	}
	...
	public void verifyForbiddenRequestForInvalidBearerTokenObjectMethod() {
		RequestSpecification httpRequest= null;
		ObjectLayerGetAPIPage.verifyWrongBearerTokenForGETAPIObjectLayer(httpRequest,member);
	}
}
