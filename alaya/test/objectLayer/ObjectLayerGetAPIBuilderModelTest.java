...
public class ObjectLayerGetAPIBuilderModelTest extends MainClassAlaya {
	 ...
	 * */
	   ...
	   public static String builderModel = "builder_model";
		...
		public void verifySuccessForGetAPIObjectLayer() throws InterruptedException, JsonMappingException, JsonProcessingException, ParseException {
			...
			ObjectLayerGetAPIPage.verifySuccessStatusforGETAPIObjectLayer(httpRequest,builderModel);	
		}
		...
		public void verifyResponseForWrongSystemLocaleObjectMethod() {
			RequestSpecification httpRequest= null;
			ObjectLayerGetAPIPage.verifyResponseForWrongSystemLocale(httpRequest,builderModel);
		}
		...
		public void verifyResponseForWrongDocumentTypeObjectMethod() {
			RequestSpecification httpRequest= null;
			ObjectLayerGetAPIPage.verifyResponseForWrongDocType(httpRequest,builderModel);
		}
		...
		public void verifyResponseForWrongDocumentObjectMethod() {
			RequestSpecification httpRequest= null;
			ObjectLayerGetAPIPage.verifyResponseForWrongDocument(httpRequest,builderModel);
		}
		...
		public void verifyResponseForDeletedDocumentObjectMethod() {
			RequestSpecification httpRequest= null;
			ObjectLayerGetAPIPage.verifyResponseForDeletedDocument(httpRequest,builderModel);
		}
		...
		public void verifyAttributesObjectMethod() {
			...
			ObjectLayerGetAPIPage.verifyAttributesForObjectLayer(httpRequest,builderModel,AttributeNamesForDocStore,AttributeNamesForES);
		}
		...
		public void verifyForbiddenRequestForInvalisSessionObjectMethod() {
			RequestSpecification httpRequest= null;
			ObjectLayerGetAPIPage.verifyWrongSessionKeyForGETAPIObjectLayer(httpRequest,builderModel);
		}
		...
		public void verifyForbiddenRequestForInvalidBearerTokenObjectMethod() {
			RequestSpecification httpRequest= null;
			ObjectLayerGetAPIPage.verifyWrongBearerTokenForGETAPIObjectLayer(httpRequest,builderModel);
		}
}
