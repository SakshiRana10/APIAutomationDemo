...
public class ObjectLayerGetAPISubdivisionTest extends MainClassAlaya {
	...
	public void verifySuccessForGetAPIObjectLayer() throws InterruptedException, JsonMappingException, JsonProcessingException, ParseException {
		...
		ObjectLayerGetAPIPage.verifySuccessStatusforGETAPIObjectLayer(httpRequest,subdivision);	
	}
	...
	public void verifyResponseForWrongSystemLocaleObjectMethod() {
		RequestSpecification httpRequest= null;
		ObjectLayerGetAPIPage.verifyResponseForWrongSystemLocale(httpRequest,subdivision);
	}
	...
	public void verifyResponseForWrongDocumentTypeObjectMethod() {
		RequestSpecification httpRequest= null;
		ObjectLayerGetAPIPage.verifyResponseForWrongDocType(httpRequest,subdivision);
	}
	...
	public void verifyResponseForWrongDocumentObjectMethod() {
		RequestSpecification httpRequest= null;
		ObjectLayerGetAPIPage.verifyResponseForWrongDocument(httpRequest,subdivision);
	}
	...
	public void verifyResponseForDeletedDocumentObjectMethod() {
		RequestSpecification httpRequest= null;
		ObjectLayerGetAPIPage.verifyResponseForDeletedDocument(httpRequest,subdivision);
	}
	...
	public void verifyAttributesObjectMethod() {
		...
		ObjectLayerGetAPIPage.verifyAttributesForObjectLayer(httpRequest,subdivision,AttributeNamesForDocStore,AttributeNamesForES);
	}
	...
	public void verifyForbiddenRequestForInvalisSessionObjectMethod() {
		RequestSpecification httpRequest= null;
		ObjectLayerGetAPIPage.verifyWrongSessionKeyForGETAPIObjectLayer(httpRequest,subdivision);
	}
	...
	public void verifyForbiddenRequestForInvalidBearerTokenObjectMethod() {
		RequestSpecification httpRequest= null;
		ObjectLayerGetAPIPage.verifyWrongBearerTokenForGETAPIObjectLayer(httpRequest,subdivision);
	}
